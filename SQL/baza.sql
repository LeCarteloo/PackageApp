...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "C##FILIP"."ODBIORCA_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 121 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence POJAZDY_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "C##FILIP"."POJAZDY_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence PRZESYLKA_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "C##FILIP"."PRZESYLKA_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 121 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence PRZESYLKI_INFO_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "C##FILIP"."PRZESYLKI_INFO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 121 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "C##FILIP"."PRZEWOZ_INFO_SEQ1"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "C##FILIP"."PRZEWOZ_OSOB_SEQ1"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence UZYTKOWNICY_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "C##FILIP"."UZYTKOWNICY_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 301 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence UZYTKOWNIK_KLIENT_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "C##FILIP"."UZYTKOWNIK_KLIENT_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 161 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence UZYTKOWNIK_PRACOWNIK_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "C##FILIP"."UZYTKOWNIK_PRACOWNIK_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 141 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Table CENY
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into C##FILIP.PRZESYLKA (ID_PRZESYLKA,ID_ODBIORCA,ID_KLIENT,ID_TRANSPORT,NAZWA_PRZESYLKI,STATUS,KOSZT,ID_PRACOWNIK) values ('101','101','141','101','TV 40'''' Szklane','Rejestracja','110','122');
...
Insert into C##FILIP.UZYTKOWNIK_PRACOWNIK (ID_PRACOWNIK,IMIE,NAZWISKO,PESEL,NR_TEL,ID_UZYTKOWNIK) values ('123','Filip','Papiernik','12345678910','604058333','284');
Insert into C##FILIP.UZYTKOWNIK_PRACOWNIK (ID_PRACOWNIK,IMIE,NAZWISKO,PESEL,NR_TEL,ID_UZYTKOWNIK) values ('121','Filip','Papiernik','12345678910','604058913','282');
--------------------------------------------------------
...
RAISE_APPLICATION_ERROR( -20050, 'Nie mo¿esz umówiæ siê na wizytê w przeszlosci ;)' );
end if;
end;
/
...
FOR EACH ROW
begin
IF LENGTH(TRIM(TRANSLATE(LOWER(:new.KRAJ), ' +¹æêñ³óœ¿Ÿqabcdefghijklmnoprstuvwxyz',' '))) != 0 THEN
...
FOR EACH ROW
begin
IF LENGTH(TRIM(TRANSLATE(LOWER(:new.MIASTO), ' +¹æêñ³óœ¿Ÿqabcdefghijklmnoprstuvwxyz',' '))) != 0 THEN
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "C##FILIP"."PESEL_TRIGGER" 
BEFORE INSERT ON ODBIORCA
FOR EACH ROW
begin
...
BEGIN
  ...
  BEGIN
    IF INSERTING AND :NEW.ID_UZYTKOWNIK IS NULL THEN
      SELECT UZYTKOWNICY_SEQ.NEXTVAL INTO :NEW.ID_UZYTKOWNIK FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
...
--------------------------------------------------------
--  DDL for Trigger UZYTKOWNIK_KLIENT_TRG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "C##FILIP"."UZYTKOWNIK_KLIENT_TRG" 
BEFORE INSERT ON UZYTKOWNIK_KLIENT 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.ID_KLIENT IS NULL THEN
      SELECT UZYTKOWNIK_KLIENT_SEQ.NEXTVAL INTO :NEW.ID_KLIENT FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "C##FILIP"."UZYTKOWNIK_KLIENT_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger UZYTKOWNIK_PRACOWNIK_TRG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "C##FILIP"."UZYTKOWNIK_PRACOWNIK_TRG" 
...
BEGIN
  ...
  BEGIN
    IF INSERTING AND :NEW.ID_PRACOWNIK IS NULL THEN
      SELECT UZYTKOWNIK_PRACOWNIK_SEQ.NEXTVAL INTO :NEW.ID_PRACOWNIK FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "C##FILIP"."UZYTKOWNIK_PRACOWNIK_TRG" ENABLE;
--------------------------------------------------------
